 ...
 * Generated at: 2022-07-22 05:47:04 UTC
...
public final class placeadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("			\r\n");
      out.write("			<form method=\"post\" action=\"/planitshare/adminpage/place/add.do\" enctype=\"multipart/form-data\">\r\n");
      ...
      out.write("					</tr>\r\n");
      out.write("					<tr>\r\n");
      out.write("						<th>이미지 업로드</th>\r\n");
      out.write("						<td colspan=\"3\">\r\n");
      out.write("							<input type=\"file\" name=\"image\" id=\"image\" class=\"form-control-file\"/>\r\n");
      out.write("						</td>\r\n");
      out.write("					</tr>\r\n");
      out.write("					<tr>\r\n");
      out.write("						<td colspan=\"4\">\r\n");
      out.write("							<button class=\"btn btn-primary\" id=\"submit-btn\">등록하기</button>\r\n");
      out.write("						</td>\r\n");
      out.write("					</tr>\r\n");
      out.write("				</table>\r\n");
      out.write("			</form>\r\n");
      ...
      out.write("			$.ajax({\r\n");
      out.write("				type: 'GET',\r\n");
      out.write("				url: '/planitshare/adminpage/place/add/distinct.do',\r\n");
      out.write("				data: 'distinct=' + $('#distinct').val(),\r\n");
      out.write("				dataType: 'json',\r\n");
      out.write("				success: function(result) {\r\n");
      out.write("					\r\n");
      out.write("					$('#time').html('');\r\n");
      out.write("					\r\n");
      out.write("					if($('#distinct').val() == 'lodging') {\r\n");
      out.write("						\r\n");
      out.write("						let temp = '';\r\n");
      out.write("						\r\n");
      out.write("						temp += '<th>체크인 시각</th>';\r\n");
      out.write("						temp += '<td>';\r\n");
      out.write("						temp += '<input type=\"time\" name=\"checkin\" id=\"checkin\" class=\"form-control\" required/>';\r\n");
      out.write("						temp += '</td>';\r\n");
      out.write("						temp += '<th>체크아웃 시각</th>';\r\n");
      out.write("						temp += '<td>';\r\n");
      out.write("						temp += '<input type=\"time\" name=\"checkout\" id=\"checkout\" class=\"form-control\" required/>';\r\n");
      out.write("						temp += '</td>';\r\n");
      out.write("						\r\n");
      out.write("						$('#time').append(temp);\r\n");
      out.write("						\r\n");
      out.write("					} else {\r\n");
      out.write("						\r\n");
      out.write("						let temp = '';\r\n");
      out.write("						\r\n");
      out.write("						temp += '<th>영업시작시각</th>';\r\n");
      out.write("						temp += '<td>';\r\n");
      out.write("						temp += '<input type=\"time\" name=\"open\" id=\"checkin\" class=\"form-control\" required/>';\r\n");
      out.write("						temp += '</td>';\r\n");
      out.write("						temp += '<th>영업종료시각</th>';\r\n");
      out.write("						temp += '<td>';\r\n");
      out.write("						temp += '<input type=\"time\" name=\"close\" id=\"checkout\" class=\"form-control\" required/>';\r\n");
      out.write("						temp += '</td>';\r\n");
      out.write("						\r\n");
      out.write("						$('#time').append(temp);\r\n");
      out.write("					}\r\n");
      ...
      out.write("					$('#category').append('<option value=\"\" selected disabled>카테고리를 선택해주세요.</option>');\r\n");
      out.write("					\r\n");
      out.write("					$.each(result, function(index, item) {\r\n");
      out.write("						$('#category').append('<option value=\"' + item.seq + '\">' + item.category + '</option>');\r\n");
      out.write("					});\r\n");
      out.write("					\r\n");
      out.write("				},\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/admin/placeadd.jsp(80,8) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("distrincts");
      // /WEB-INF/views/admin/placeadd.jsp(80,8) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/admin/placeadd.jsp(80,8) '${distrincts}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${distrincts}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
