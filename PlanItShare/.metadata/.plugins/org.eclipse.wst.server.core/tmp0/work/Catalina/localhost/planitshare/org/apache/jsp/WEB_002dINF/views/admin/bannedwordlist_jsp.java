 ...
 * Generated at: 2022-07-22 04:57:56 UTC
...
public final class bannedwordlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("         	</div>\r\n");
      out.write("         		<div id=\"each\">\r\n");
      out.write("         		<div class=\"board\">\r\n");
      out.write("	         		<div>\r\n");
      out.write("	         		<form method=\"GET\" action=\"/planitshare/admin/bannedwordadd.do\">\r\n");
      out.write("					<h1 class=\"ins\">금칙어 등록</h1>\r\n");
      out.write("					<span  class=\"ins\">\r\n");
      out.write("					<input type=\"text\" name=\"word\" id=\"banadd\"/>\r\n");
      ...
      out.write("					</div>\r\n");
      out.write("					\r\n");
      out.write("				<form method=\"GET\" action=\"/planitshare/admin/bannedwordlist.do\" id=\"multidelete\">\r\n");
      out.write("				<table class=\"table table-bordered\">\r\n");
      out.write("				<tr>\r\n");
      out.write("					<th><input type=\"checkbox\" name=\"all\" id=\"cbox\" width=\"200px\"/></th>\r\n");
      out.write("					<th style=\"text-align: center;\">금지어명</th>\r\n");
      out.write("				</tr>\r\n");
      out.write("				");
      ...
      out.write("\r\n");
      out.write("					<button class=\"btn btn-secondary\" style=\"float:right;\">삭제</button>\r\n");
      out.write("				</div>\r\n");
      out.write("				</form>\r\n");
      out.write("				\r\n");
      out.write("				</div>\r\n");
      ...
      out.write("					<h1 class=\"ins\">금칙어 게시글</h1>\r\n");
      out.write("				</div>\r\n");
      out.write("				\r\n");
      out.write("				<form method=\"GET\" action=\"/planitshare/admin/bannedwordlist.do\" id=\"multideleteplan\">\r\n");
      out.write("				<table class=\"table table-bordered\">\r\n");
      out.write("					<tr>\r\n");
      out.write("						<th><input type=\"checkbox\" name=\"all\" id=\"cbox1\"/></th>\r\n");
      out.write("						<th>작성글제목</th>\r\n");
      out.write("						<th>금칙어</th>\r\n");
      out.write("						<th>작성자</th>\r\n");
      out.write("						<th>등록일</th>\r\n");
      out.write("					</tr>\r\n");
      ...
      out.write("		\r\n");
      out.write("		location.href = '/toy/board/list.do?page=' + $(this).val() + \"&column=");
      ...
      out.write(");\r\n");
      out.write("	\r\n");
      out.write("	$(\"#cbox\").click(function() { //전체 선택 + 선택 해제\r\n");
      out.write("		\r\n");
      out.write("		var checked = $(this).prop(\"checked\");\r\n");
      out.write("		\r\n");
      out.write("		if (checked) {\r\n");
      out.write("			$(\":checkbox[name=chk]\").prop(\"checked\", true);\r\n");
      out.write("		} else {\r\n");
      out.write("			$(\":checkbox[name=chk]\").prop(\"checked\", false)				\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
      out.write("	$(\"#cbox1\").click(function() { //전체 선택 + 선택 해제\r\n");
      out.write("		\r\n");
      out.write("		var checked = $(this).prop(\"checked\");\r\n");
      out.write("		\r\n");
      out.write("		if (checked) {\r\n");
      out.write("			$(\":checkbox[name=chk1]\").prop(\"checked\", true);\r\n");
      out.write("		} else {\r\n");
      out.write("			$(\":checkbox[name=chk1]\").prop(\"checked\", false)				\r\n");
      out.write("		}\r\n");
      out.write("		\r\n");
      out.write("	});\r\n");
      out.write("	\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/admin/bannedwordlist.jsp(108,4) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/admin/bannedwordlist.jsp(108,4) '${list}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/admin/bannedwordlist.jsp(108,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("dto");
      // /WEB-INF/views/admin/bannedwordlist.jsp(108,4) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("				<tr>\r\n");
            out.write("					<td id=\"cbox\"  style=\"text-align: center;\"><input type=\"checkbox\" class=\"chk1\" name=\"chk\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${list[status.index].seq}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\"/></td>\r\n");
            out.write("					<td id=\"word\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.word}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("				</tr>\r\n");
            out.write("				");
  ...
  private boolean _jspx_meth_c_005fif_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/admin/bannedwordlist.jsp(114,4) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("				<tr>\r\n");
          out.write("					<td colspan=\"2\" style=\"text-align: center;\">등록된 금지어가 없습니다.</td>\r\n");
          out.write("				</tr>\r\n");
          out.write("				");
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/admin/bannedwordlist.jsp(145,5) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/admin/bannedwordlist.jsp(145,5) '${plist}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${plist}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/views/admin/bannedwordlist.jsp(145,5) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("dto");
      // /WEB-INF/views/admin/bannedwordlist.jsp(145,5) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            out.write("\r\n");
            out.write("					<tr>\r\n");
            out.write("						<td id=\"cbox1\"><input type=\"checkbox\" name=\"chk1\" value=\"");
            ...
            out.write("</td>\r\n");
            out.write("						<td id=\"word1\">");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.banned}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\r\n");
            out.write("						<td id=\"word1\">");
  ...
  private boolean _jspx_meth_c_005fif_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/admin/bannedwordlist.jsp(154,5) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f5.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${plist.size() == 0}", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      int _jspx_eval_c_005fif_005f5 = _jspx_th_c_005fif_005f5.doStartTag();
      if (_jspx_eval_c_005fif_005f5 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("					<tr>\r\n");
          out.write("						<td colspan=\"5\" style=\"text-align: center;\">금지어로 등록된 게시글이 없습니다.</td>\r\n");
          out.write("					</tr>\r\n");
          out.write("					");
